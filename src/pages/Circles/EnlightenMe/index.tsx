  ...
  return (
    <div className="w-full h-140 relative p-5">
      ...
      <div className="w-full flex flex-col gap-2 text-sm font-medium leading-normal text-black">
        <p>
          Our AI model is able to analyze your recent browser history to generate some
          circles for you based on interest. Would you like us to do that?
        </p>
        <p>
          We strictly protects your privacy and no human will see your browsing history;
          your data will only be used by the AI model to generate circles for you.
        </p>
      </div>
