...
import { getCircleLoadingMessage, resizeAndConvertImageToBuffer } from 'utils/helpers'
      ...
      <div className="w-full flex flex-col gap-2 justify-between">
        {isSaving && (
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 transform self-center border-gray-600 flex flex-col gap-y-3">
            <div className="-mt-6">
              <p className="text-sm font-medium leading-normal text-center text-brand">
                Running on background
              </p>
              <p className="text-base font-medium leading-normal text-center text-primary">
                {message}...
              </p>
